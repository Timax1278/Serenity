<template>
    <div class="register-container">
      <div class="register-box" v-if="!loading">
        <h1>Register</h1>
...
export default {
    ...
    submitForm () {
      ...
      setTimeout(() => {
        if (this.email && this.username && this.password) {
          ...
          // Qui puoi gestire la logica per la registrazione dell'utente
          localStorage.setItem('user', JSON.stringify({ email: this.email, username: this.username }))
  ...
  /* Box registrazione con animazione di apparizione */
  .register-box {
